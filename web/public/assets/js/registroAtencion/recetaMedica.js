                    ...
                    if(value.idmedicamento==idmedicamento){
                        ...
                        content += `
                            ...
                            <td>
                                ...
                                <select data-id="` + counter + `" id="via_administracion` + counter + `" class="form-control via_administracion form-control-sm" name="via_administracion` + counter + `">
                                    <option value=""></option>
                                ...
                                <input id="via_otros` + counter + `" placeholder="Escriba aquí" class="form-control mt-2 d-none">
                            </td>
                            <td>
...
$(document).on('change','.via_administracion',function(){
    valor = $(this).val();
    id = $(this).attr("data-id");
    if(valor=="Otros"){
     
        $('#via_otros'+id).removeClass('d-none');
    }else{
        $('#via_otros'+id).removeClass('d-none');
        $('#via_otros'+id).addClass('d-none');
    }
})
...
$('.generar').click( function() {
    ...
    if(contar!="" && contar!=-1){
        ...
        for(var i=medic; i<= contar; i++){
            ...
            if($("#via_administracion"+i).val()=="Otros"){
                if($("#via_otros"+i).val()=="" || $("#via_otros"+i).val()==undefined){
                    $('#alerts').html('<div class="alert alert-info">' +
                        '<button type="button" class="close" data-dismiss="alert">' +
                        '&times;</button> Ingrese la descripción de otros en la vía de administración '+i+' </strong></div>');
                    return false;
                }
            }
            ...
            if($("#via_administracion"+i).val()=="Otros"){
                via_administracion = $("#via_otros"+i).val();
            }else{
