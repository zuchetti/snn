...
@section('content')
		...
		<div class="kt-portlet kt-portlet--mobile">
			...
			<div class="kt-portlet__head kt-portlet__head--lg row myhead">
                ...
                <div class="col-md-4 text-right">
                    <a href="{{url('nuevoActivoFijo')}}" class="btn" id="boton3"><i class="fas fa-plus"></i> Agregar activo fijo</a>
                </div>
			</div>
            ...
            <div class="kt-portlet__body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <label class="col-form-label col-lg-10 col-sm-10">Buscar por nombre o código de inventario</label>
    ...
    <input type="hidden"  id="idactivofijo">
...
<script src="{{ asset('assets/js/sanna/activosFijos/administrar.js')}}" type="text/javascript"></script>
@endpush