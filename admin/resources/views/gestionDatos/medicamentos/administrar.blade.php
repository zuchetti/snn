		...
		<div class="kt-portlet kt-portlet--mobile">
			...
			<div class="kt-portlet__head kt-portlet__head--lg row myhead">
                ...
                <div class="col-md-4 text-right">
                    <a href="{{url('nuevoMedicamento')}}" class="btn" id="boton3"><i class="fas fa-plus"></i> Agregar medicamento</a>
                </div>
			</div>
...
@endsection
@push('scripts')
<script src="{{ asset('assets/js/sanna/medicamentos/administrar.js') }}" type="text/javascript"></script>
