				...
				columns: [
                    ...
                    },
					{
						...
						template: function(row,index) {
							return '<a href="detalleEmpresa?idempresa='+row.idempresa+'&empresa='+row.empresa+'" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Detalle">\
							<i class="fas fa-eye"></i>\
							</a>\
							<a href="editCliente?idempresa='+row.idempresa+'&empresa='+row.empresa+'" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Detalle">\
							<i class="far fa-edit"></i>\
							</a>'+
							'<div  onclick="remover('+row.idempresa+')" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Detalle">\
