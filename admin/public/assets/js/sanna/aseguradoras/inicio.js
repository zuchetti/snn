				...
				columns: [
					...
					},
					{
						...
						template: function(row,index) {
							return '<a href="editAseguradora?idaseguradora='+row.idaseguradora+'&aseguradora='+row.aseguradora+'" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Detalle">\
							<i class="far fa-edit"></i>\
							</a>'+
							'<div  onclick="remover('+row.idaseguradora+')" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Detalle">\
...
//remover
function remover(idaseguradora){
	
	$("#idaseguradora").val(idaseguradora)
...
function handleAccept(){
	...
	$.ajax({
        'url': "deleteAseguradora",
        beforeSend: function() {
			$('.accept').prop('disabled', true);
        },
		'data':{'idaseguradora':$("#idaseguradora").val()},
	}).done( function(data) {
