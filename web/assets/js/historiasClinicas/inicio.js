		...
		datatable=$(".kt-datatable").KTDatatable({
				...
				columns: [
					...
					
					{
						...
						autoHide: false,
						template: function(row,index) {
							return '<a href="HistoryClinicDetail?dni='+row.dni+'&nombre='+row.nombres+'" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Detalle">\
							<i class="fas fa-eye"></i>\
							</a>\
							<a href="all_attentions?dni='+row.dni+'" target="_blank" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Detalle">\
