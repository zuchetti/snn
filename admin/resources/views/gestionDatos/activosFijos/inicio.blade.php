    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
		<div class="kt-portlet kt-portlet--mobile">
			...
			<div class="kt-portlet__head kt-portlet__head--lg row myhead">
               ...
               <!-- <div class="col-md-4">
                    <a href="{{url('nuevoGrupoActivoFijo')}}" class="btn" id="boton"> <i class="fas fa-fw fa-plus"></i> Agregar nuevo grupo</a>
                </div> -->
                <div class="col-md-4">
                    <a href="{{url('administrarActivosFijos')}}" class="btn" id="boton"><i class="far fa-list-alt"></i> Adminsitrar activos</a>
                </div>
                <div class="col-md-4 text-right">
                    <a href="{{url('nuevoGrupoActivoFijo')}}" class="btn" id="boton3"><i class="fas fa-plus"></i> Agregar grupo</a>
                </div>
			</div>
...
@push('scripts')
    <script src="{{asset('assets/js/sanna/activosFijos/inicio.js') }}" type="text/javascript"></script> 
