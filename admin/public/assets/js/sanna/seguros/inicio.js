				...
				columns: [
					...
					},
					{
						...
						template: function(row,index) {
							return '<a href="editSeguro?idtiposeguro='+row.idtiposeguro+'&seguro='+row.seguro+'" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Detalle">\
							<i class="far fa-edit"></i>\
							</a>'+
							'<div  onclick="remover('+row.idtiposeguro+')" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Detalle">\
...
function handleAccept(){
	...
	$.ajax({
		...
		'data':{'idtiposeguro':$("#idtiposeguro").val()},
	}).done( function(data) {
