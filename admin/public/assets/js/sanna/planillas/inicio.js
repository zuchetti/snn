				...
				columns: [
					...
					},
					{
						...
						template: function(row,index) {
							return '<a href="editPlanilla?idtipoplanilla='+row.idtipoplanilla+'&planilla='+row.planilla+'" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Detalle">\
							<i class="far fa-edit"></i>\
							</a>'+
							'<div  onclick="remover('+row.idtipoplanilla+')" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Detalle">\
...
//remover
function remover(idtipoplanilla){
	
	$("#idtipoplanilla").val(idtipoplanilla)
...
function handleAccept(){
	...
	$.ajax({
		...
		'data':{'idtipoplanilla':$("#idtipoplanilla").val()},
	}).done( function(data) {
