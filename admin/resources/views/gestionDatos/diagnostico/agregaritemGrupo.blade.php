            ...
            <div class="kt-portlet__body">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-sm-5">
                        <button class="btn agregar" idgrupo="{{$idgrupo}}" nombre="{{$nombre}}" id="boton">
...
@push('scripts')
    <script src="{{asset('assets/js/sanna/diagnostico/agregaritemGrupo.js') }}" type="text/javascript"></script> 
