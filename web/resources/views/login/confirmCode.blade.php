                        ...
                        <div class="justify-content-center">
                            <div class="col-md-10 mx-auto">
                                ...
                                <div class="text-center">
                                    <a href="https://200.48.199.90:8002/sanna/web/public/"><img src="{{ asset('/assets/images/login/login.svg') }}" class="img-fluid logo"></a>
                                </div>
                                <br>
                                <p >La contraseña debe ser mayor a 12 caracteres y debe de cumplir con un mínimo 3 de 4 requisitos: Una mayúscula, minúscula, caracter especial , número</p>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm campo"  maxlength=4 id="codigo" autocomplete="off"   placeholder="Ingrese el código">
                                </div> 
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-6 mx-auto">
                                        <button id="button" class="btn update">
