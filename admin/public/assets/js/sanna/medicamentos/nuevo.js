$('.agregar').click( function() {
    ...
    $.ajax({
        'url': "aggMedicamentAll",
        'data':{'cant_presentacion':cant_presentacion,'tipo':tipo,'cod_producto':cod_producto,'producto':producto,'presentacion':presentacion,
        'precio_costo1':precio_costo1,
        ...
        if(obj.status == 200){
            ...
            window.setTimeout(function(){window.location.href = 'administrarMedicamento'},1000);
