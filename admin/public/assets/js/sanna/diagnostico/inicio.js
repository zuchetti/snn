	...
	init:function()
	{
		...
		datatable=$(".kt-datatable").KTDatatable({
				...
				columns: [
                    ...
                    {
						field: 'nombre',
						title: 'Grupos de diagnóstico',
                    },
                    {
						field: 'diagnosticos',
						title: 'Cantidad de diagnóstico',
                    },
                   
					{
						...
						autoHide: false,
						template: function(row,index) {
							return '<a href="detalleGrupoDiagnostico?idgrupo='+row.idgrupo+'&nombre='+row.nombre+'" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Detalle">\
							<i class="fas fa-eye"></i>\
							</a>\
                            <div onclick="remover('+row.idgrupo+')" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Acciones">\
