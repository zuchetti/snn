...
@section('content')
    ...
    <input class="form-control" type="hidden" value="{{$idtiposeguro}}" id="idtiposeguro">
		...
		<div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-4">
                        <label>Nombre de del seguro</label>
                        <input type="text" value="{{$seguro}}" class="letrasyn form-control form-control-sm campo" id="seguro">
...
@push('scripts')
<script src="{{asset('assets/js/sanna/seguros/editar.js') }}" type="text/javascript"></script> 
@endpush