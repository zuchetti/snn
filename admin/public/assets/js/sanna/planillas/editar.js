...
$('.agregar').click( function() {
    ...
    if(planilla=="" || planilla==undefined){
        ...
        '&times; </button> Ingrese el nombre de la planilla</div>');
        return false;
    }

    $.ajax({
        'url': "updatePlanilla",
        'data':{'planilla':planilla,'idtipoplanilla':idtipoplanilla},
        beforeSend: function() {
        ...
        if(obj.status == 200){
            ...
            window.setTimeout(function(){window.location.href = 'planilla'},1000);
