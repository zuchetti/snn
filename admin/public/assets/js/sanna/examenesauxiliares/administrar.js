                ...
                columns: [
                    {
                        ...
                        template: function(row, index) {
                            idexamenauxiliar=row.idexamenauxiliar;
                             return ''
                        },
                    },
                     {
                        ...
                        template: function(row, index) {
                            var status = {
                                0: {'title': 'Imagen', 'class': 'kt-badge--brand'},
                                1: {'title': 'Laboratorio', 'class': 'kt-badge--success'},
                            };

                            return  status[row.tipo].title
                        },
                        
                        },{
                        field: 'precio',
                        title: 'Precio unitario S/N IGV',
                        ...
                        autoHide: false,
                        template: function(row,index) {
                            return '<a href="editExamen?idexamenauxiliar='+row.idexamenauxiliar+'" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Acciones">\
                                <i class="far fa-edit"></i>\
                            </a>\
                            <div onclick="remover('+row.idexamenauxiliar+')" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Acciones">\
...
//remover
function handleAccept(idexamenauxiliar){
	$.ajax({
        'url': "deleteExamenAll",
        beforeSend: function() {
			$('.accept').prop('disabled', true);
        },
		'data':{'idexamenauxiliar':$("#idexamenauxiliar").val()},
...
function remover(idexamenauxiliar){
		
    $("#idexamenauxiliar").val(idexamenauxiliar)
