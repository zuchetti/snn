		...
		<div class="kt-portlet kt-portlet--mobile">
			...
			<div class="kt-portlet__head kt-portlet__head--lg row myhead">
                ...
                <div class="col-md-4 text-right">
                    <a href="{{url('addSucliente')}}?idempresa={{$idempresa}}&empresa={{$empresa}}" class="btn" id="boton"> <i class="fas fa-fw fa-plus"></i> Agregar subcliente</a>
                </div>
...
@push('scripts')
<script src="{{asset('assets/js/sanna/clientes/detalle.js') }}" type="text/javascript"></script> 
