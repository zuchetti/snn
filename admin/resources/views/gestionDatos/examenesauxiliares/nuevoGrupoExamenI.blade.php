            ...
            <div class="kt-portlet__body">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-sm-4">
                        <label>Seleccione el examen de imagen</label>
                    ...
                    <div class="col-lg-4 col-sm-4">
                        <br>
                        <button class="btn addMedicamentI"> <i class="fas fa-plus"></i> Añadir examen</button>
                    </div>
                </div>
                <br>
               ...
               <table class="table">
                   <thead>
                       <tr>
                           <th scope="col"></th>
                           <th scope="col">Nombre del examen imagen</th>
                           <th scope="col">precio</th>
                       </tr>
                   </thead>
                   <tbody id="examenImagen">
