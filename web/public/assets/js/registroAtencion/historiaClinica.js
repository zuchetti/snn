...
$('.generar').click( function() {
    ...
    if(procedencia=="" || procedencia==undefined){
        $('#alerts').html('<div class="alert alert-info">' +
            '<button type="button" class="close" data-dismiss="alert">' +
            '&times;</button>Ingrese la procedencia </strong></div>');
        return false;
    }
    if(ocupacion=="" || ocupacion==undefined){
        $('#alerts').html('<div class="alert alert-info">' +
            '<button type="button" class="close" data-dismiss="alert">' +
            '&times;</button> Ingrese el campo ocupación </strong></div>');
        return false;
    }
    if(religion=="" || religion==undefined){
        $('#alerts').html('<div class="alert alert-info">' +
            '<button type="button" class="close" data-dismiss="alert">' +
            '&times;</button> Ingrese el campo religión </strong></div>');
        return false;
    }

    if(gradoinstitucion=="" || gradoinstitucion==undefined){
        $('#alerts').html('<div class="alert alert-info">' +
            '<button type="button" class="close" data-dismiss="alert">' +
            '&times;</button>Complete el campo grado de instrucción </strong></div>');
        return false;
    }
...
$('input[name="autorizacion"]').on('change',function(){
    $('input[name="autorizacion"]').not(this).prop('checked',false);
})
