...
@section('content')
    ...
    <input class="form-control" type="hidden" value="{{$idaseguradora}}" id="idaseguradora">
            ...
            <div class="kt-portlet__body">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-4">
                        ...
                        <input type="text" value="{{$aseguradora}}" class="letrasyn form-control form-control-sm campo" id="aseguradora">
...
@push('scripts')
<script src="{{asset('assets/js/sanna/aseguradoras/editar.js') }}" type="text/javascript"></script> 
@endpush