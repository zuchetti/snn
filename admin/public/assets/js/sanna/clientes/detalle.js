				...
				columns: [
                    ...
                    },
                    {
                        ...
                        template: function(row,index) {
                            return '<div onclick="remover('+row.idsede+')" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Acciones">\
...
//remover
function handleAccept(idsede){
	$.ajax({
        'url': "deleteSubcliente",
        beforeSend: function() {
			$('.accept').prop('disabled', true);
        },
		'data':{'idsubcliente':$("#idsede").val()},
