            ...
            <div class="kt-portlet__body">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="letrasyn form-control form-control-sm campo" id="aseguradora">
...
@push('scripts')
<script src="{{asset('assets/js/sanna/aseguradoras/nuevo.js') }}" type="text/javascript"></script> 
@endpush