...
@section('content')
    ...
    <input class="form-control" type="hidden" value="{{$idtipocondicion}}" id="idtipocondicion">
            ...
            <div class="kt-portlet__body">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-4">
                        ...
                        <input type="text" value="{{$condicion}}" class="letrasyn form-control form-control-sm campo" id="condicion">
...
@push('scripts')
<script src="{{asset('assets/js/sanna/condiciones/editar.js') }}" type="text/javascript"></script> 
@endpush