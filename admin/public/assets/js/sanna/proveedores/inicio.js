				...
				columns: [
                    ...
                    },
					{
						...
						template: function(row,index) {
							return '<a href="detalleProveedor?idproveedor='+row.idproveedor+'&razon_social='+row.razon_social+'" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Detalle">\
							<i class="fas fa-eye"></i>\
							</a>'+
							'<a href="editProveedor?idproveedor='+row.idproveedor+'&razon_social='+row.razon_social+'" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Detalle">\
							<i class="far fa-edit"></i>\
							</a>'+
							'<div  onclick="remover('+row.idproveedor+')" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Detalle">\
