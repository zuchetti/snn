        ...
        datatable=$(".kt-datatable").KTDatatable({
                ...
                columns: [
                    ...
                    ,{
                        ...
                        autoHide: false,
                        template: function(row,index) {
                            return '<a href="editDiagnostico?iddiagnostico='+row.iddiagnostico+'&diagnostico='+row.diagnostico+'" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Acciones">\
                                <i class="far fa-edit"></i>\
                            </a>\
                            <div onclick="remover('+row.iddiagnostico+')" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Acciones">\
...
function remover(iddiagnostico){
...
//remover
function handleAccept(iddiagnostico){
	$.ajax({
        'url': "deleteDiagnosticoAll",
        beforeSend: function() {
			$('.accept').prop('disabled', true);
        },
		'data':{'iddiagnostico':$("#iddiagnostico").val()},
