<html>
    <head>
        ...
        <link rel="icon" type="image/png" href="<?php echo e(asset('assets/images/logo/favicon.png')); ?>" sizes="64x64">
        <title>Iniciar sesión | Sanna</title>
        <link href="<?php echo e(URL::asset('/assets/css/bootstrap.min.css')); ?>" rel="stylesheet">
        <link href="<?php echo e(URL::asset('/assets/css/all.min.css')); ?>" rel="stylesheet">
        <link href="<?php echo e(URL::asset('/assets/css/login/login.css')); ?>" rel="stylesheet">
        <script>url='<?php echo e(asset('')); ?>'</script>
    ...
    <body>
                        ...
                        <div class="justify-content-center">
                            <div class="col-md-10 mx-auto">
                                ...
                                <div class="text-center">
                                    <a href="https://200.48.199.90:8090/sanna/web/public/"><img src="<?php echo e(asset('/assets/images/login/login.svg')); ?>" class="img-fluid logo"></a>
                                </div>
                                ...
                                <div class="text-right">
                                    <a href="<?php echo e(url('forgetPassword')); ?>" id="olv">Olvide mi contraseña</a>
                                </div>
                                <br>
        ...
        <script src="<?php echo e(URL::asset('/assets/js/login/login.js')); ?>"></script>

    </body>
</html><?php /**PATH C:\Eureka\htdocs\sanna\web83\resources\views/login/login.blade.php ENDPATH**/ ?>