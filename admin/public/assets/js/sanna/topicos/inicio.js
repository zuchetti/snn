		...
		datatable=$(".kt-datatable").KTDatatable({
				...
				columns: [
                    ...
                    },			
					{
						...
						autoHide: false,
						template: function(row,index) {
							return '<a href="detalleTopico?idtopico='+row.idtopico+'&nombre='+row.nombre+'&idbotiquin='+row.idbotiquin+'" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Detalle">\
							<i class="fas fa-eye"></i>\
							</a>'+
							'<div  onclick="remover('+row.idtopico+')" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Detalle">\
