		...
		<div class="kt-portlet kt-portlet--mobile">
			...
			<div class="kt-portlet__head kt-portlet__head--lg row myhead">
               ...
               <div class="col-md-4 text-right">
                    <a href="{{url('nuevoCliente')}}" class="btn" id="boton"> <i class="fas fa-fw fa-plus"></i> Agregar cliente</a>
                </div>
               <!--  <div class="col-md-4 text-right">
                    <a href="{{url('nuevoSubcliente')}}" class="btn" id="boton"> <i class="fas fa-fw fa-plus"></i> Agregar subcliente</a>
                </div> -->
			</div>
...
<script src="{{asset('assets/js/sanna/clientes/inicio.js') }}" type="text/javascript"></script> 
@endpush