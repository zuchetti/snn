                 ...
                 request = $.ajax({                                   
                    ...
                    success: function(data) {       
                        ...
                        if (obj.status ==200){
                            ...
                            if(nuevo==0){
                                window.setTimeout(function(){window.location.href = 'aggGrupoMDE?idtopico='+idtopico+'&idbotiquin='+idbotiquin},1000);
                            }else{
                                window.setTimeout(function(){window.location.href = 'calendario_horariotopico?idtopico='+idtopico},1000);
