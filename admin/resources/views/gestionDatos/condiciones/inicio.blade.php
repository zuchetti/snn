...
@section('content')
		...
		<div class="kt-portlet kt-portlet--mobile">
			...
			<div class="kt-portlet__head kt-portlet__head--lg row myhead">
               ...
               <div class="col-md-4 text-right">
                    <a href="{{url('nuevoCondicion')}}" class="btn" id="boton"> <i class="fas fa-fw fa-plus"></i> Agregar</a>
                </div>
    ...
    <input type="hidden"  id="idtipocondicion">
...
<script src="{{asset('assets/js/sanna/condiciones/inicio.js') }}" type="text/javascript"></script> 
@endpush