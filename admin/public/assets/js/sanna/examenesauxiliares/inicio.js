	...
	init:function()
	{
		...
		datatable=$(".kt-datatable").KTDatatable({
				...
				data: {
					...
					source: {
						read: {
							url: "getExamenauxiliarGrupoTabla",
							params: {
								pag:pag,
								query: query,
								fecha_ini: fecha_ini,
				...
				columns: [
					{
						...
						width: 200,
						field: 'nombre',
						title: 'Grupo de exámenes',
					}, {
						field: 'examenes',
						title: 'Nº de exámenes',
						...
						autoHide: false,
						template: function(row,index) {
							return '<a href="detalleGrupoExamen?idgrupo='+idgrupo+'&nombre='+row.nombre+'" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Detalle">\
