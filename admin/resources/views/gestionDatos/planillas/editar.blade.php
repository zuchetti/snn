...
@section('content')
    ...
    <input class="form-control" type="hidden" value="{{$idtipoplanilla}}" id="idtipoplanilla">
		...
		<div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-4">
                        <label>Nombre de de la planilla</label>
                        <input type="text" value="{{$planilla}}" class="letrasyn form-control form-control-sm campo" id="planilla">
...
<script src="{{asset('assets/js/sanna/planillas/editar.js') }}" type="text/javascript"></script> 
@endpush