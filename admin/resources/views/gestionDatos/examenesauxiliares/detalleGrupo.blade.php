		...
		<div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__head kt-portlet__head--lg row myhead">
                ...
                <div class="col-md-4 text-right">
                     <button nombre="{{$nombre}}" idgrupo="{{$idgrupo}}" class="btn" id="boton3"><i class="fas fa-plus"></i> Agregar examen a Grupo </button> 
                </div>
			</div>
...
<script src="{{ asset('assets/js/sanna/examenesauxiliares/detalleGrupo.js') }}" type="text/javascript"></script>
@endpush