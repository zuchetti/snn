    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
		<div class="kt-portlet kt-portlet--mobile">
			...
			<div class="kt-portlet__head kt-portlet__head--lg row myhead">
               ...
               <div class="col-md-4">
                    <a href="{{url('nuevoGrupoDiagnostico')}}" class="btn" id="boton"> <i class="fas fa-fw fa-plus"></i> Agregar nuevo grupo</a>
                </div>
                <div class="col-md-4">
                    <a href="{{url('administrarDiagnosticos')}}" class="btn" id="boton"><i class="far fa-list-alt"></i> Adminsitrar diagnóstico</a>
                </div>
			</div>
...
<script src="{{asset('assets/js/sanna/diagnostico/inicio.js') }}" type="text/javascript"></script> 
@endpush