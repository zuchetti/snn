    ...
    init:function()
    {
        ...
        datatable=$(".kt-datatable").KTDatatable({
                ...
                data: {
                    ...
                    source: {
                        read: {
                            url: "getActivosFijosDetailGrupo",
                            params: {
                                pag:pag,
                                idgrupo: idgrupo,
                                petxpag: petxpag
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        template: function(row, index) {
                            ...
                            return  tipo[row.propiedad].title;                            
                        },
...

                    {
                        ...
                        autoHide: false,
                        template: function(row,index) {
                            return '<div onclick="remover('+row.idgrupo+','+row.idgrupoitem+')" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Acciones">\
        ...
        $(document).on('click', "#boton3", function(e){
            ...
            location.href='agregaritemGrupoActivofijo?idgrupo='+idgrupo+'&nombre='+nombre;
              
        }),
...
//remover
function remover(idgrupo,idgrupoitem){
...
//remover
function handleAccept(idgrupo,idgrupoitem){
	$.ajax({
        'url': "deleteGrupoActivosFijos",
        beforeSend: function() {
			$('.accept').prop('disabled', true);
        },
		'data':{'idgrupo':$("#idgrupo").val(),'idgrupoitem':$("#idgrupo").val()},
