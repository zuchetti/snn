                    ...
                    <div class="divLogin text-center">
                        <div class="justify-content-center">
                            <div class="col-md-10 mx-auto">
                                ...
                                <form id="uploadForm" method="post" action="validate_code_first">
                                    ...
                                    <div>
                                        <h1 id="h1" class="h4">1. Escanea el QR con tu Google Authenticator App</h1>
                                        <div class="card-body">
                                            {!! QrCode::size(140)->generate($url) !!}
                                        </div>
                                    </div>
                                    <input type="hidden" name="keySecret" value="{{$info->data->secretKey}}">

                                    <h1 id="h1" class="h4">2. Ingrese el PIN de Google Authenticator App</h1>
