                ...
                columns: [
                    {
                    ...
                    },
                     {
                        ...
                        autoHide: false,
                        template: function(row,index) {
                            return '<a href="editMedicamento?idmedicamento='+row.idmedicamento+'" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Acciones">\
                                <i class="far fa-edit"></i>\
                            </a>\
                            <div onclick="remover('+row.idmedicamento+')" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Acciones">\
...
//remover
function remover(idmedicamento){
...
//remover
function handleAccept(idmedicamento){
	$.ajax({
        'url': "deleteMedicamentAll",
        beforeSend: function() {
			$('.accept').prop('disabled', true);
        },
		'data':{'idmedicamento':$("#idmedicamento").val()},
