				...
				columns: [
					...
					},
					{
						...
						template: function(row,index) {
							return '<a href="editCondicion?idtipocondicion='+row.idtipocondicion+'&condicion='+row.condicion+'" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Detalle">\
							<i class="far fa-edit"></i>\
							</a>'+
							'<div  onclick="remover('+row.idtipocondicion+')" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Detalle">\
...
//remover
function remover(idtipocondicion){
	
	$("#idtipocondicion").val(idtipocondicion)
...
function handleAccept(){
	...
	$.ajax({
		...
		'data':{'idtipocondicion':$("#idtipocondicion").val()},
	}).done( function(data) {
