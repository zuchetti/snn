						...
						<div class="kt-grid__item kt-grid__item--fluid kt-wizard-v4__wrapper">
							...
							<form class="kt-form" id="kt_user_add_form">
								...
								<div class="kt-wizard-v4__content" data-ktwizard-type="step-content" data-ktwizard-state="current">
									<input type="hidden" value="{{$info->data[0]->idusuario}}" id="id">
													...
													<div class="kt-section__body">
														<div class="form-group row">
															<div class="col-lg-9 col-xl-6">
																<h3 class="kt-section__title kt-section__title-md">Editar Usuario</h3>
															</div>
														</div>
														<div id="alertaa"></div>
														...
														<div class="form-group row">
															...
															<div class="col-lg-9 col-xl-9">
																<input class="form-control" type="text" value="{{$info->data[0]->nombres}}" id="nombre">
															</div>
														</div>
														<div class="form-group row">
															<label class="col-xl-3 col-lg-3 col-form-label">Apellidos</label>
															<div class="col-lg-9 col-xl-9">
																<input class="form-control" type="text" value="{{$info->data[0]->apellidos}}" id="apellidos">
															</div>
														</div>
														<div class="form-group row">
															...
															<div class="col-lg-9 col-xl-9">
																<div class="input-group">
																	...
																	<input type="text" class="form-control" id="email" value="{{$info->data[0]->email}}" placeholder="Email" aria-describedby="basic-addon1">
																</div>
															</div>
														</div>
														<div class="form-group row">
															...
															<div class="col-lg-9 col-xl-9">
																<input class="form-control" maxlength="9" type="text" value="{{$info->data[0]->dni}}" id="dni">
															</div>
														</div>
														<div class="form-group row">
															<label class="col-xl-3 col-lg-3 col-form-label">Contraseña</label>
															<div class="col-lg-9 col-xl-9">
																<input class="form-control" type="password" value="123456" id="pass" passorigi="{{$info->data[0]->password}}">
															</div>
														</div>
														<div class="form-group row">
															<label class="col-xl-3 col-lg-3 col-form-label">Validar Contraseña</label>
															<div class="col-lg-9 col-xl-9">
																<input class="form-control" type="password" value="123456" id="pass2">
															</div>
														</div>
														<div class="form-group row">
															...
															<div class="col-lg-9 col-xl-9">
																<select id="idrol" class="form-control">
																	<option value="{{$info->data[0]->idrol}}">{{$info->data[0]->rol}}</option>
...
@endsection
@push('scripts')
 <script src="{{ asset('/assets/js/sanna/usuario/editarusuario.js') }}" type="text/javascript"></script>
@endpush