                ...
                <div class="col-md-4">
                    <div class="kt-portlet__head-label">
                        ...
                        <h3 class="kt-portlet__head-title" >
                            Nuevo grupo de medicamentos
                        </h3>
                    </div>
                </div>
                <div class="col-md-4 text-right">
                    <a href="{{url('administrarMedicamento')}}" class="btn" id="boton3"><i class="far fa-list-alt"></i> Adminsitrar medicamentos</a>
                </div>
			</div>
                ...
                <div class="col-lg-3 col-sm-4">
                    <div style="margin-right:14px;">
                        <button class="btn agregar" onclick="createGroup()" id="boton" >
                            Crear grupo  <span class="spinner-border spinner-border-sm" disabled style="display:none;"></span>
                        </button>
                    </div>
