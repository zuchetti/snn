	...
	init:function()
	{
		...
		datatable=$(".kt-datatable").KTDatatable({
				...
				data: {
					...
					source: {
						read: {
							url: "reposicionMedicamentosTable",
							params: {
								pag:pag,
								query: query,
								fecha_ini: fecha_ini,
				...
				columns: [
					...
					}, 
					{
                        ...
                        var status = {                           
                            ...
                            1: {'title': 'Aprobado ', 'class': 'kt-badge--success'},
					                ...
					                
					{
						...
						autoHide: false,
						template: function(row,index) {
							return '<a href="resposicionDetail?idreposicionh='+row.idreposicionh+'&state='+row.state+'" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Detalle">\
