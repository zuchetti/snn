		...
		datatable=$(".kt-datatable").KTDatatable({
				...
				columns: [
                   ...
                   
					{
						...
						autoHide: false,
						template: function(row,index) {
							return '<a href="detalleGrupoActivosFijos?idgrupo='+row.idgrupo+'&nombre='+row.nombre+'" class="btn btn-sm btn-clean btn-icon btn-icon-sm" title="Detalle">\
