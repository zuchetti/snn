                ...
                <div class="col-md-4">
                    <div class="kt-portlet__head-label">
                        ...
                        <h3 class="kt-portlet__head-title" >
                                Grupo de exámenes auxiliares
                        </h3>
                    </div>
                </div>
                <div class="col-md-4">
                    <a href="{{url('nuevoGrupoExamen')}}" class="btn" id="boton"> <i class="fas fa-fw fa-plus"></i> Agregar nuevo grupo</a>
                </div>
                <div class="col-md-4">
                    <a href="{{url('administrarExamen')}}" class="btn" id="boton"><i class="far fa-list-alt"></i> Administrar examenes</a>
                </div>
			</div>
...
@push('scripts')
<script src="{{asset('assets/js/sanna/examenesauxiliares/inicio.js') }}" type="text/javascript"></script> 
