            ...
            <div class="kt-portlet__body">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-4">
                        ...
                        <label>Exámen</label>
                        <input type="text" class="letrasyn form-control form-control-sm campo" id="examen">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control form-control-sm campo decimales" maxlength=5 id="precio">
...
@endsection
@push('scripts')
<script src="{{ asset('assets/js/sanna/examenesauxiliares/nuevo.js') }}" type="text/javascript"></script>
@endpush