$('.agregar').click( function() {
    ...
    $.ajax({
        'url': "updateDiagnosticoAll",
        'data':{'cie10':cie10,'diagnostico':diagnostico,'iddiagnostico':iddiagnostico},
        beforeSend: function() {
        ...
        if(obj.status == 200){
            ...
            $('#boton').prop('disabled', true);
            window.setTimeout(function(){window.location.href = 'administrarDiagnosticos'},1000);
        }
