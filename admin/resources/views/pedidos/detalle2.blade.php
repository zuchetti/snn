                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-6">
                        <form id="uploadForm" method="post" action="update_stock_botiquin"  enctype="multipart/form-data">
                            ...
                            <input class="form-control form-control-lg" required disabled name="file" id="formFileLg" type="file"
                            accept=".csv" >
                            <br>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-6 mx-auto">
                                    <div class="text-center">
                                        <button type="submit"   id="boton3" disabled class="btn boton4">Subir</button>
                                    </div>
                                </div>
                            </div>
