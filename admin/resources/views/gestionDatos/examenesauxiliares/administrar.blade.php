...
@section('content')
		...
		<div class="kt-portlet kt-portlet--mobile">
			...
			<div class="kt-portlet__head kt-portlet__head--lg row myhead">
                ...
                <div class="col-md-4 text-right">
                    <a href="{{url('nuevoExamen')}}" class="btn" id="boton3"><i class="fas fa-plus"></i> Agregar examen</a>
                </div>
			</div>
                ...
                <div id="alerts"></div>
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-4 kt-margin-b-20-tablet-and-mobile">
                        <label class="col-form-label col-lg-10 col-sm-10">Seleccione el tipo</label>
    ...
    <input type="hidden"  id="idexamenauxiliar">
...
<script src="{{ asset('assets/js/sanna/examenesauxiliares/administrar.js') }}" type="text/javascript"></script>
@endpush